...
sprites.player.armRocket = love.graphics.newImage('sprites/newPlayer/armRocket.png')
sprites.player.armSpear = love.graphics.newImage('sprites/newPlayer/armSpear.png')
sprites.player.armSpearLoaded = love.graphics.newImage('sprites/newPlayer/armSpearLoaded.png')
